        ...
        <div className="w-8/12">
          <div className="w-10/12 mx-auto">
            <div className="w-44 h-44 mt-12">
              <img className="h-full w-full object-cover" src={book} alt="" />
            </div>
            <div>
              ...
              <p className=" group-hover:text-white transition ">
                NextGen offers professional book cover design services that
                capture the essence of your story and entice readers. Our
                designers combine creativity and market insights to produce
                covers.
              </p>
            </div>
            <div className="mt-20">
