          ...
          <div className="w-10/12 mx-auto">
            ...
            <div>
              ...
              <p className=" group-hover:text-white transition ">
                Showcase your products in the best light with NextGen's product
                video services. We produce engaging and informative videos that
                demonstrate the features and benefits of your products.
              </p>
            </div>
            <div className="mt-20">
