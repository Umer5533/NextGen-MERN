...
const Pricing = () => {
  ...
  const Bas = () => (
    <div className="p-7">
      <div className="flex justify-between  mb-5">
        <p className="uppercase">basic</p> <p>PKR 7,312</p>
      </div>
      <div className="mb-4">
        <p>
          Any small minor Audio / Video editing task. If unsure. Kindly contact
          me in inbox
        </p>
      </div>
      <div className="flex mb-4 ">
        ...
        <div className="flex items-center ml-6 ">
          ...
          <p className="font-bold"> 1 Revision</p>
        </div>
      </div>
      ...
      <div>
        <ul>
          <li  className="mb-2">
            ...
            <span className="ml-3 ">Up to 15 minutes of footage provided</span>
          </li>
          <li className="mb-2">
            <img className="inline w-4" src={check} alt="" />

            <span className="ml-3 ">Up to 1 minute running time</span>
          </li>
          <li className="mb-2">
            <img className="inline w-4" src={check} alt="" />

            <span className="ml-3 ">Color grading</span>
          </li>
          <li className="mb-2">
            <img className="inline w-4" src={check} alt="" />

            <span className="ml-3 ">Sound design & mixing</span>
          </li>
          <li className="mb-2">
            <img className="inline w-4" src={check} alt="" />

            <span className="ml-3 ">Motion graphics</span>
          </li>
          <li className="mb-2">
            <img className="inline w-4" src={check} alt="" />

            <span className="ml-3 ">Subtitles</span>
          </li>
        </ul>
      </div>
      <div className="mt-6">
  ...
  const Sta = () => (
    <div className="p-7">
      <div className="flex justify-between  mb-5">
        <p className="uppercase">standard</p> <p>PKR 17,549</p>
      </div>
      <div className="mb-4">
        <p>
        A small scale project. If unsure. Kindly contact me in inbox
        </p>
      </div>
      <div className="flex mb-4 ">
        <div className="flex items-center">
        ...
        <div className="flex items-center ml-6 ">
          ...
          <p className="font-bold"> 2 Revision</p>
        </div>
      </div>
      ...
      <div>
        <ul>
          ...
          <li className="mb-2">
            ...
            <span className="ml-3 ">Up to 3 minute running time</span>
          </li>
          <li className="mb-2">
            <img className="inline w-4" src={check} alt="" />
  ...
  const Pre = () => (
    <div className="p-7">
      <div className="flex justify-between  mb-5">
        <p className="uppercase">premium</p> <p>PKR 29,248</p>
      </div>
      <div className="mb-4">
        <p>
        A medium scale project. If unsure. Kindly contact me in inbox
        </p>
      </div>
      <div className="flex mb-4 ">
        <div className="flex items-center">
        ...
        <div className="flex items-center ml-6 ">
          ...
          <p className="font-bold"> 3 Revision</p>
        </div>
      </div>
      ...
      <div>
        <ul>
          <li  className="mb-2">
            ...
            <span className="ml-3 ">Up to 30 minutes of footage provided</span>
          </li>
          <li className="mb-2">
            <img className="inline w-4" src={check} alt="" />

            <span className="ml-3 ">Up to 6 minute running time</span>
          </li>
          <li className="mb-2">
            <img className="inline w-4" src={check} alt="" />
